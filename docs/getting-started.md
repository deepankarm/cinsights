...
- **Already use Claude Code or Codex?** Start with [local](sources/local.md). Reads `~/.claude` and `~/.codex` directly. No setup.
...
- **Already have Phoenix running?** Use [Phoenix](sources/phoenix.md). Plugs into your existing observability setup.
